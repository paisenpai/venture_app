        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center">
          <div className="max-w-lg">
            <div className="w-full">
              <span className="text-indigo-900 text-4xl md:text-6xl font-extrabold font-['Typold'] [text-shadow:_1px_2px_2px_rgb(23_18_92_/_0.44)]">
                Ready to slay <br />
                your next{" "}
              </span>
              <span className="text-indigo-700 text-4xl md:text-6xl font-extrabold font-['Typold'] [text-shadow:_1px_2px_2px_rgb(23_18_92_/_0.44)]">
                Quest
              </span>
              <span className="text-indigo-900 text-4xl md:text-6xl font-extrabold font-['Typold'] [text-shadow:_1px_2px_2px_rgb(23_18_92_/_0.44)]">
                ?
